...
EarlOutcomeValue.PASSED = new EarlOutcomeValue('passed');
EarlOutcomeValue.FAILED = new EarlOutcomeValue('failed');
EarlOutcomeValue.INAPPLICABLE = new EarlOutcomeValue('inapplicable');
EarlOutcomeValue.UNTESTED = new EarlOutcomeValue('untested');
